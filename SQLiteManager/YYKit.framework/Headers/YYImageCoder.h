...
/**
 ...
 before rendering the next frame on the card.
 */
typedef NS_ENUM(NSUInteger, YYImageDisposeMethod) {
    
    /**
     No disposal is done on this frame before rendering the next; the contents
     of the card are left as is.
     */
    YYImageDisposeNone = 0,
    
    /**
     The frame's region of the card is to be cleared to fully transparent black
     before rendering the next frame.
     */
    YYImageDisposeBackground,
    
    /**
     The frame's region of the card is to be reverted to the previous contents
     before rendering the next frame.
     */
...
/**
 ...
 blended with those of the previous card.
 */
typedef NS_ENUM(NSUInteger, YYImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's card region.
     */
    YYImageBlendNone = 0,
...
@property (nonatomic) NSUInteger offsetX;  ///< Frame origin.x in card (left-bottom based)
@property (nonatomic) NSUInteger offsetY;  ///< Frame origin.y in card (left-bottom based)
...
@property (nonatomic, readonly) NSUInteger width;          ///< Image card width.
@property (nonatomic, readonly) NSUInteger height;         ///< Image card height.
